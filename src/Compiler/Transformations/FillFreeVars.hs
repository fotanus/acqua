...
fillFreeVars (MultiApp t1 t2) = MultiApp (fillFreeVars t1) (map fillFreeVars t2)
...
fillFreeVars (Concat3 t1 t2 t3) = Concat3 (fillFreeVars t1) (fillFreeVars t2) (fillFreeVars t3)
