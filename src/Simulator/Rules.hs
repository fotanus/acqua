...
import Simulator.Rules.EndReqCopy
...
rules = [
  ...
  receiveUpdateMetaClos, receiveUpdateMetaList, receiveResponse, receiveUpdate, receiveUpdateClos, receiveUpdateList, endCopy, endReqCopy,
